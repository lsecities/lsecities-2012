        ...
        jQuery(document).ready(function($) {
          ...
          try {
            ...
            if(jQuery(selector).length > 0) {
              jQuery(selector).galleria({responsive: true, height: 0.4, transition: 'fade', transitionSpeed: 600, carousel: false, thumbnails: false, autoplay: 5000, showInfo: false, preload: 'all', debug: <?php echo is_user_logged_in() ? 'true' : 'false'; ?>});
