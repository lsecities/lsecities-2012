...
require_fragment('/lib/lsecities/award/award.php');
...
require_fragment('/lib/lsecities/grid-slideshow/grid-slideshow.php');
require_fragment('/lib/lsecities/group/group.php');
require_fragment('/lib/lsecities/page/page.php');
...
require_fragment('/lib/lsecities/tile/tile.php');
