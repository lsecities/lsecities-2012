...
function pods_prepare_research_project($pod_slug) {
  ...
  $obj['research_output_categories'] = array('book', 'journal-article', 'book-chapter', 'research-data', 'research-report', 'conference-newspaper', 'conference-proceedings', 'conference-report', 'report', 'blog-post', 'interview', 'magazine-article', 'essay', 'book-review');
