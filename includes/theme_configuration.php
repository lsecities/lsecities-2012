 ...
 */
lc_data('theme_base_path', '//' . $_SERVER['SERVER_NAME'] . '/wp-content/themes/lsecities-alexandria/');
lc_data('theme_filesystem_abspath', ABSPATH . '/wp-content/themes/lsecities-alexandria');
