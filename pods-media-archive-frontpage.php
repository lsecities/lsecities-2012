  ...
  <div id="post-<?php the_ID(); ?>" <?php post_class('lc-article lc-media-archive-search'); ?>>
    <div class='ninecol' id='contentarea'>
      <div class='top-content'>
        ...
        <article class="wireframe" data-ng-controller="StaticMediaArchiveCtrl">
                    ...
                    <form method="get" action="">
                      ...
                      <div class="fourcol">
                        ...
                        <ul>
                          <li>
                            <label>
                              <input type="checkbox" value="audio" checked="checked" disabled="disabled" data-ng-model="mediatypes.audio">audio
                            </label>
                          </li>
                          <li>
                            <label>
                              <input type="checkbox" value="video" checked="checked" disabled="disabled" data-ng-model="mediatypes.video">video
                            </label>
                          </li>
                        </ul>
                      </div>
